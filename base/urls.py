...
from base.views.order_views import (OrderDetail, getOrders,
                                    updateOrderToDelivered, getMyOrders)
from base.views.user_views import (updateUser, getUserById, deleteUser,
                                   getUsers, registerUser, updateUserProfile,
                                   getUserProfile, MyTokenObtainPairView)
from base.views.product_views import (AdminProductDetail, getTopProducts,
                                      createProductReview, uploadImage,
...
urlpatterns = [
    ...
    path('products/<str:pk>/reviews/',
         createProductReview, name='product-reviews'),
    path('products/<str:pk>/', getProduct, name='product'),
    path('product/<str:pk>/',
         AdminProductDetail.as_view(), name='admin-product'),
    ...
    path('users/profile/update/', updateUserProfile,
    ...
    path('orders/<str:pk>/deliver/',
         updateOrderToDelivered, name='user-order'),
]
